   ...
   return (
      <div className='relative min-h-screen w-full'>
         ...
         <div
            ...
            className='fixed top-5 right-2 z-50 w-32  opacity-30 hover:opacity-100 bg-card rounded-lg shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl'
         >
